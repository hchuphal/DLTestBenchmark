...
def _main_menu():
    ...
    print Formats.WARNING + "1. Execute Benchmarking Tasks (7) >> " + Formats.ENDC
    print Formats.WARNING + "2. Check Output " + Formats.ENDC
    print Formats.WARNING + "3. Check Output Parsing Capability " + Formats.ENDC
    ...
    _menu = {
        '1' : _run_tasks,
        '2' : _check_tasks_status,
        '3' : _check_output,
        '4' : _check_parsing,
        '5' : _check_dl_testing_tool,
        '5' : _check_version,
        '7' : _help_,
        '8' : _quit
    }
